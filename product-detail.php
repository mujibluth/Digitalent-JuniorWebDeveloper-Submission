...
<head>
  ...
  <title>Produk &mdash; Perusahaan KeyMoto</title>
          ...
          <div class="uk-container">
            <div class="section-hero__content">
              <div class="section-hero__title">
                <div class="uk-h1">BMW motorcycle</div>
              </div>
            ...
            <div class="uk-grid uk-flex-middle" data-uk-grid>
              <div class="uk-width-2-3@m">
                <div class="page-product__title">
                  <div class="uk-h1">2021 BMW S1000 RR</div><span>Always Pushing To Full Limits For A Great Riding Experience!</span>
                </div>
              </div>
              <div class="uk-width-1-3@m">
                <div class="page-product__price">
                  <div><span class="current">$6,200</span><span class="old">MSRP: $7,800</span></div>
                ...
                <div class="page-product__gallery">
                  <div data-uk-slideshow="min-height: 300; max-height: 430">
                    <ul class="uk-slideshow-items uk-child-width-1-1">
                      <li><img class="uk-width-1-1" src="assets/img/img-gallery-1.jpg" alt="img-gallery" data-uk-cover></li>
                      <li><img class="uk-width-1-1" src="assets/img/img-gallery-2.jpg" alt="img-gallery" data-uk-cover></li>
                      <li><img class="uk-width-1-1" src="assets/img/img-gallery-3.jpg" alt="img-gallery" data-uk-cover></li>
                      <li><img class="uk-width-1-1" src="assets/img/img-gallery-4.jpg" alt="img-gallery" data-uk-cover></li>
                      <li><img class="uk-width-1-1" src="assets/img/img-gallery-5.jpg" alt="img-gallery" data-uk-cover></li>
                    </ul>
                    <div class="uk-margin-top" data-uk-slider>
                      <ul class="uk-thumbnav uk-slider-items uk-grid uk-grid-small uk-child-width-1-3 uk-child-width-1-4@m uk-child-width-1-5@l">
                        <li data-uk-slideshow-item="0"><a href="#"><img src="assets/img/img-gallery-1.jpg" alt="img-gallery"></a></li>
                        <li data-uk-slideshow-item="1"><a href="#"><img src="assets/img/img-gallery-2.jpg" alt="img-gallery"></a></li>
                        <li data-uk-slideshow-item="2"><a href="#"><img src="assets/img/img-gallery-3.jpg" alt="img-gallery"></a></li>
              ...
              <div class="uk-width-1-3@m">
                <div class="product-block-info">
                  <div class="product-block-info__user user">
                    <div class="user__avatar"><img src="assets/img/news-avatar-1.jpg" alt="Joesph Hill"></div>
                  ...
                  <div class="product-block-info__email block-icon">
                    ...
                    <div class="block-icon__desc">
                      ...
                      <div class="block-icon__value"><a href="mailto:joseph.hill@domain.com">joseph.hill@domain.com</a></div>
                    </div>
                  </div>
                  <div class="product-block-info__phone block-icon">
                    ...
                    <div class="block-icon__desc">
                      ...
                      <div class="block-icon__value"><a href="tel:12584037960">+1 (258) 403 7960</a></div>
                    </div>
                  </div>
                </div>
                <aside class="sidebar">
          ...
          <div class="uk-grid uk-child-width-1-3@m" data-uk-grid>
            <div>
              <div class="product-item uk-transition-toggle">
                <div class="product-item__head">
                  <div>
                    <div class="product-item__name"> <a href="product-detail.php">DUCATI HYPER 950</a></div>
                ...
                <div class="product-item__media uk-inline-clip uk-inline"><img src="assets/img/product-4.jpg" alt="DUCATI HYPER 950" /><a class="uk-transition-fade" href="product-detail.php">
            ...
            <div>
              <div class="product-item uk-transition-toggle">
                <div class="product-item__head">
                  <div>
                    <div class="product-item__name"> <a href="product-detail.php">KAWASAKI VULCAN</a></div>
                ...
                <div class="product-item__media uk-inline-clip uk-inline"><img src="assets/img/product-5.jpg" alt="KAWASAKI VULCAN" /><a class="uk-transition-fade" href="product-detail.php">
                    <div class="uk-overlay-cover uk-overlay-primary"></div>
                     <div class="uk-position-center"><span class="icon-cross"></span></div>
                  </a><button class="product-item__whish btn-whish"><i class="far fa-heart"></i></button></div>
                <div class="product-item__info">
            ...
            <div>
              <div class="product-item uk-transition-toggle">
                <div class="product-item__head">
                  <div>
                    <div class="product-item__name"> <a href="product-detail.php">HONDA CB500X ABS</a></div>
                ...
                <div class="product-item__media uk-inline-clip uk-inline"><img src="assets/img/product-6.jpg" alt="HONDA CB500X ABS" /><a class="uk-transition-fade" href="product-detail.php">
                    <div class="uk-overlay-cover uk-overlay-primary"></div>
                     <div class="uk-position-center"><span class="icon-cross"></span></div>
                  </a><button class="product-item__whish btn-whish"><i class="far fa-heart"></i></button></div>
                <div class="product-item__info">
